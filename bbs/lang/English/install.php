...
'Already installed'				=>	'It seems like BBS is already installed. You should go <a href="index.php">here</a> instead.',
...
'My BBS Forum'				=>	'My BBS Forum',
'Description'					=>	'Unfortunately no one can be told what BBS is - you have to see it for yourself.',
...
'No DB extensions'				=>	'This PHP environment does not have support for any of the databases that BBS supports. PHP needs to have support for either MySQL, PostgreSQL or SQLite in order for FluxBB to be installed.',
'Administrator username'		=>	'Administrator\'s username',
'Administrator email'			=>	'Administrator\'s email',
'Board title'					=>	'Board title',
'Base URL'						=>	'The URL (without trailing slash) of your BBS forum. This must be correct.',
'Required field'				=>	'is a required field in this form.',
'BBS Installation'			=>	'BBS Installation',
'Welcome'						=>	'You are about to install BBS. In order to install BBS, you must complete the form set out below. If you encounter any difficulties with the installation, please refer to the documentation.',
'Install'						=>	'Install BBS %s',
...
'Info 4'						=>	'The name of the database you want to install BBS on.',
...
'Info 6'						=>	'If you want to run multiple BBS installations in a single database, change this.',
...
'Existing table error'			=>	'A table called \'%susers\' is already present in the database \'%s\'. This could mean that BBS is already installed or that another piece of software is installed and is occupying one or more of the table names BBS requires. If you want to install multiple copies of BBS in the same database, you must choose a different table prefix',
...
'Message'						=>	'If you are looking at this (which I guess you are), the install of BBS appears to have worked! Now log in and head over to the administration control panel to configure your forum.',
'Test category'					=>	'Test category',
'Test forum'					=>	'Test forum',
'This is just a test forum'		=>	'This is just a test forum',
'Alert cache'					=>	'<strong>The cache directory is currently not writable!</strong> In order for BBS to function properly, the directory <em>%s</em> must be writable by PHP. Use chmod to set the appropriate directory permissions. If in doubt, chmod to 0777.',
...
'BBS has been installed'		=>	'BBS has been installed. To finalize the installation please follow the instructions below.',
'Final instructions'			=>	'Final instructions',
'Info 17'						=>	'To finalize the installation, you need to click on the button below to download a file called config.php. You then need to upload this file to the root directory of your BBS installation.',
'Info 18'						=>	'Once you have uploaded config.php, BBS will be fully installed! At that point, you may <a href="index.php">go to the forum index</a>.',
'Download config.php file'		=>	'Download config.php file',
'BBS fully installed'		    =>	'BBS has been fully installed! You may now <a href="index.php">go to the forum index</a>.',
