...
'Version number help'				=>	'Show BBS version number in footer.',
...
'Clickable links help'				=>	'When enabled, BBS will automatically detect any URLs in posts and make them clickable hyperlinks.',
...
'Quick post help'					=>	'When enabled, BBS will add a quick reply form at the bottom of topics. This way users can post directly from the topic view.',
...
'Upload directory help'				=>	'The upload directory for avatars (relative to the BBS root directory). PHP must have write permissions to this directory.',
...
'Report new help'					=>	'If enabled, BBS will notify users on the mailing list (see above) when a new user registers in the forums.',
