...
'Update'						=>	'Update BBS',
'Update message'				=>	'Your BBS database is out-of-date and must be upgraded in order to continue. If you are the board administrator, please follow the instructions below to complete the upgrade.',
'Note'							=>	'Note:',
...
'Database password info'		=>	'To perform the database update please enter the database password with which BBS was installed. If you cannot remember, this is stored in your \'config.php\' file.',
...
'You are running error'			=>	'You are running %1$s version %2$s. BBS %3$s requires at least %1$s %4$s to run properly. You must upgrade your %1$s installation before you can continue.',
'Version mismatch error'		=>	'Version mismatch. The database \'%s\' doesn\'t seem to be running a BBS database schema supported by this update script.',
...
'Invalid password error'		=>	'Invalid database password. To upgrade BBS you must enter your database password exactly as it appears in your \'%s\'',
...
'No charset conversion'			=>	'<strong>IMPORTANT!</strong> BBS has detected that this PHP environment does not have support for the encoding mechanisms required to do UTF-8 conversion from character sets other than ISO-8859-1. What this means is that if the current character set is not ISO-8859-1, BBS won\'t be able to convert your forum database to UTF-8 and you will have to do it manually. Instructions for doing manual charset conversion can be found in the update instructions.',
...
'Error info 1'					=>	'There was an error converting some users. This can occur when converting from BBS v1.2 if multiple users have registered with very similar usernames, for example "bob" and "böb".',
