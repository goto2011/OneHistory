...
'Running latest version message'	=>	'您使用的是BBS的最新版本。',
'New version available message'		=>	'已经有新的BBS版本发布。您可在以下地址下载最新版 %s.',
'Not available'						=>	'不可用',
'Forum admin head'					=>	'论坛管理设置',
'NA'								=>	'N/A',
'Welcome to admin'					=>	'欢迎来到 BBS 管理设置面板。从这里您可以控制整个论坛设置的方方面面。以下功能的可用性将取决于您是论坛管理员还是版主：',
