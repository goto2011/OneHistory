...
function pun_mail($to, $subject, $message, $reply_to_email = '', $reply_to_name = '')
{
	...
	$headers = 'From: '.$from.$EOL.'Date: '.gmdate('r').$EOL.'MIME-Version: 1.0'.$EOL.'Content-transfer-encoding: 8bit'.$EOL.'Content-type: text/plain; charset=utf-8'.$EOL.'X-Mailer: BBS Mailer';
