...
(
    ...
    (
        ...
        array("陶器", "super", "multe-key", "陶器", "黑陶", "白陶", "彩陶", "陶片", "陶雏器", "陶俑", 
            "陶轮", "陶瓷", "唐三彩", "釉", "窑", "瓷", "景德镇"),
        array("青铜器", "super", "multe-key", "青铜器", "青铜", "红铜", "鼎", "铜器"),
        array("铁器", "super", "multe-key", "铁器", "冶铁"),
        ...
        array("房屋", "super", "multe-key", "房屋", "庇护所", "山洞", "木屋", "茅屋", "建筑"),
        array("服装"),
        array("饮食"),
        array("武器"),
        array("堡垒"),
        ...
        array("文字"),
        array("祭祀墓葬", "normal", "multe-key", "祭祀", "墓葬", "埋葬", "巫师", "祭司", 
            "瓮棺", "石棺", "悬棺", "封土", "火葬", "土葬", "水葬", "天葬", "陪葬品", 
            "墓穴", "墓道"),
        array("婚姻", "normal", "multe-key", "婚姻", "家庭", "社会分工"),
    ...
    (
        // 古代文明
        array("苏美尔文明", "super", "multe-key", "苏美尔"),
