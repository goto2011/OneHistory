...
(
    ...
    (
        ...
        array("太监", "normal", "multe-key", "阉人", "寺人", "内监", "锦衣卫", "内书堂", "敬事房", 
            "东厂", "西厂", "内厂", "内务府"),
    ...
    (
        ...
        array("言论自由", "super", "sigle-key", "新闻自由"),
        array("司法独立", "super", "multe-key", "司法改革", "律师"),
        array("食品安全", "super", "sigle-key", "毒奶粉", ""),
        array("权贵资本", "normal", "multe-key", "红二代", "太子党", "反腐", "贪污", 
            "腐败", "腐化", "受贿", "行贿", "裙带", "双规"),
        array("财政税收", "super", "multe-key", "财政", "税收", "社会保障", "社保"),
        array("私人资本", "super", "multe-key", "民企", "私企", "私营企业", "私有企业"),
        array("公有制", "super", "multe-key", "国企", "国有企业", "国家所有制", "集体所有制"),
        array("公民社会", "normal", "multe-key", "公益", "非营利", "NPO", "慈善", "群体事件", 
            "群体性事件"),
        array("户口"),
    ...
    (
        // 中国共产党
        array("中国共产党", "super", "multe-key", "中共", "总书记", "中央军委", "省委", "市委", 
            "县委", "乡镇党委", "政治局", "中央委员", "村书记", "纪委", "党委", "政法委", "组织部", 
            "中组部"),
        array("人民解放军", "super", "multe-key", "解放军", "红军", "八路军", "新四军", 
            "中央军委", "政委"),
        array("延安整风运动", "super", "multe-key", "延安整风", "第一次整风运动"),
        array("土地改革", "super", "multe-key", "土地革命", "土改", "中国土地法"),
        array("镇反", "super", "multe-key", "镇压反革命运动"),
        array("反右派", "super", "multe-key", "事情正在起变化", "反右", "右派分子", "引蛇出洞"),
        array("三年大饥荒", "super", "multe-key", "大跃进", "人民公社", "农业学大寨", "社会主义建设总路线",
            "多快好省", "以钢为纲", "大炼钢铁", "共产风", "浮夸风", "放卫星", "亩产万斤", "超英赶美",
            "三面红旗", "信阳事件", "吃饭不要钱", "大饥荒"),
        array("文化大革命", "super", "multe-key", "文革", "姚文元", "五一六通知", "红卫兵", "造反派" ,
        ...
        array("奇言奇行", "super", "multe-key", "奇言奇行"),
        
        // 组织
        array("中国国民党", "normal", "multe-key", "国民党", "孙中山", "蒋介石", "蒋经国",  
            "李登辉", "连战", "马英九", "洪秀柱", "吴敦义", "宋楚瑜"),
        array("民主进步党", "normal", "multe-key", "民进党", "林义雄", "施明德", "陈水扁", 
            "谢长廷", "苏贞昌", "蔡英文"),
    ...
    (
        // 山河湖海
        array("南海", "super", "multe-key", "南中国海", "九段线", "南沙群岛", 
                "中沙群岛", "西沙", "东沙群岛", "美济礁", "渚碧礁", "黄岩岛", "永兴岛", "三沙市"),
        array("东海", "super", "multe-key", "东中国海", "春晓油气田", "钓鱼岛"),
        array("黄海"),
        array("渤海"),
