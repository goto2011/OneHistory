...
{
    return 
'<div>这里是一个历史年表的聚合网站。它试图用众包的方式，将整个历史分解成一天一天发生着的事件，然后用标签去管理这些事件，以便构建中立的、可查证的、多角度的历史表述。
既然是众包，那么它所有的内容，包括时间、事件、标签等都可以被每个人编辑。
它具有几个特点： 
<ol>
<li>1. 它的条目很多，而且会越来越多；我希望有一天会有100万亿条。这样，平均每个地球人都可以摊到1000条，足以覆盖一个人的生老病死，以及家庭、教育、工作等方方面面。</li>
<li>2. "统一时间轴"，指所有这些条目，从182.2亿年前宇宙大爆炸起、到现在和未来的每一件事，都放在同一个时间轴上。在这个时间轴上，你可放大，可缩小，可按时间横断，可依地理细分，可顺人物勾勒，可尊文本梳理。笼天地于形内，挫万物于指端。</li>
<li>3. "无限标签"，指每个事件都可以打上无穷个标签。每一个标签，都是一把斩向"时间之河"的刀，从刀锋之上你能攫取一些东西，对比之，权衡之，追索之，品味之，深思之，然后再把它们放回去。每个标签，都意味着一种看世间的角度。</li>
</ol>
</div>';
}
