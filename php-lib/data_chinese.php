<?php
// created by duangan, 2015-1-22 -->
// support chinese character deal function.    -->

/**  
 * 通過include本文件, 你可以使用中文繁簡轉換函數zhconversion($str, $variant)
 * 如果$_GET['doconversion']或$_POST['doconversion'])有設置, 本文件將獲取
 * $_REQUEST['data']并把其轉換為$_REQUEST['variant']語言后輸出.
 *
 * 你不應該也不需要在Wordpress程序, 插件/主題 或 任何已經包含wp-config.php文件
 * 的php程序中包含本文件
 *
 * 本插件目录下convert.html是一个简单的在线繁简转换工具, 使用了本php文件. 
 * 当作是本插件的bonus吧 ^_^
 */
