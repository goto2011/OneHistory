...
?>				<form id="qjump" method="get" action="viewforum.php">
					...
					<select name="id" onchange="window.location=('viewforum.php?id='+this.options[this.selectedIndex].value)">
						<optgroup label="站务板块">
							<option value="3"<?php echo ($forum_id == 3) ? ' selected="selected"' : '' ?>>站务板块</option>
						</optgroup>
						<optgroup label="平台讨论板块">
							<option value="4"<?php echo ($forum_id == 4) ? ' selected="selected"' : '' ?>>版本基线发布</option>
